package org.openapigenerator.example.client.infrastructure
...
open class ApiClient(val baseUrl: String) {
    companion object {
        ...
        const val baseUrlKey = "org.openapigenerator.example.client.baseUrl"
    ...
    protected inline fun <reified T: Any?> responseBody(body: ResponseBody?, mediaType: String? = JsonMediaType): T? {
        ...
        if (T::class.java == File::class.java) {
            // return tempfile
            val f = java.nio.file.Files.createTempFile("tmp.org.openapigenerator.example.client", null).toFile()
            f.deleteOnExit()
